                    ...
                    <nav class="menu-2">
                        <ul class="nav wtf-menu">
                            <li class="item-select parent"><a href="#.">Adopsi</a>
                                <ul class="submenu">
                                    <li class="select-menu"> <a href="/mau-adopsi">Mau Adopsi</a> </li>
...
<div class="sub-banner" style="background-color: #60412b;">
    ...
    <img class="banner-img" src="images/adopsi/banner-adopsi.jpg" alt="">
    <div class="detail">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div>
                        <h2 style="color: white">Rawat Aku</h2>
                        <p style="color: white">Jadikan aku teman berbagimu, karena aku tidak akan pernah
                            meninggalkanmu
                            sendiri</p>
                    </div>
