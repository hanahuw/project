            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <a href="<?= base_url() ?>/" class="logo"><img
                            src="<?= base_url(); ?>/images/kittycare/home5.png"></a>
                        ...
                        <ul class="nav wtf-menu">
                            <li class="parent"><a href="#.">Adopsi</a>
                                <ul class="submenu">
                                    ...
                                    <li> <a href="<?= base_url(); ?>/caripengadopsi">Cari pengadopsi</a> </li>
                                </ul>
                            </li>
                                ...
                                <ul class="submenu">
                                    ...
                                    <li class="parent"> <a href="#">Pet shop</a> <i
                                        ...
                                        <ul class="submenu">
                                            ...
                                            <li> <a href="<?= base_url(); ?>/petshop-js">Jakarta Selatan</a>
                                            </li>
                                    ...
                                    <li class="parent"> <a href="#">Pet klinik</a> <i
                                            class="icon-chevron-small-right"></i>
                                        <ul class="submenu">
                                            <li> <a href="<?= base_url(); ?>/petklinik-jp">Jakarta Pusat</a>
                                            </li>
                                            <li> <a href="<?= base_url(); ?>/petklinik-jt">Jakarta Timur</a>
                                            </li>
                                            <li> <a href="<?= base_url(); ?>/petklinik-jb">Jakarta Barat</a>
                                            </li>
                                            <li> <a href="<?= base_url(); ?>/petklinik-ju">Jakarta Utara</a>
                                            </li>
                                            <li> <a href="<?= base_url(); ?>/petklinik-js">Jakarta Selatan</a>
                                            </li>
